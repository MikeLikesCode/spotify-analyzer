     ...
     <div className={trackStyles.Container}>
        <div style={{display:'flex', alignItems:'center'}}>
         <div className={trackStyles.Artwork}>
            <Image key={track.album.images[0].url} src={track.album.images[0].url} alt="Album Cover" width={100} height={100} />
         </div>
         <div style={{ paddingLeft: "1rem" }}>
         <h4 style={{ fontSize: "1.3rem", marginBottom: "2px", color: "white"}}>{track.name}</h4>
        ...
        <p style={{  fontSize: "0.9rem", padding: "0rem 0rem", margin:0 }}>
            ...
            <p style={{ fontSize: "0.9rem", color: "rgb(155, 155, 155)", marginBottom: "0px", padding: ".025rem 0rem", width:'10vw'}}>
